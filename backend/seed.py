...
def seed():
    ...
    segments = [
        BusinessSegment(
            name="Lending", description="Consumer and commercial lending products"
        ),
        BusinessSegment(
            name="Payments", description="Payment processing and digital wallets"
        ),
        BusinessSegment(name="Insurance", description="Insurance products and claims"),
        BusinessSegment(
            name="Wealth Management", description="Investment and advisory services"
        ),
    ]
    db.add_all(segments)
    db.flush()
    ...
    teams = [
        Team(
            name="Lending Support", description="Handles lending-related client queries"
        ),
        Team(
            name="Payments Support",
            description="Handles payment-related client queries",
        ),
        Team(name="General Support", description="Handles general customer inquiries"),
        Team(
            name="Escalation Team", description="Handles escalated and critical queries"
        ),
    ]
    db.add_all(teams)
    db.flush()
    ...
    staff_members = [
        ...
        Staff(
            name="Bob Smith", email="bob@example.com", role="agent", team_id=teams[0].id
        ),
        Staff(
            name="Carol White",
        ...
        Staff(
            name="Eve Davis", email="eve@example.com", role="agent", team_id=teams[2].id
        ),
        Staff(
            name="Frank Miller",
    ...
    clients = [
        Client(
            ...
            phone="+1-555-0101",
            business_segment_id=segments[0].id,
        ),
        Client(
            name="TechStart Inc",
            ...
            phone="+1-555-0102",
            business_segment_id=segments[1].id,
        ),
        Client(
            name="Global Trading",
            email="support@globaltrading.com",
        ...
        Client(
            ...
            email="help@safeguard.com",
            company="SafeGuard Insurance Co",
            phone="+1-555-0104",
            business_segment_id=segments[2].id,
        ),
        Client(
            name="WealthBridge",
            email="clients@wealthbridge.com",
            company="WealthBridge Advisors",
            phone="+1-555-0105",
            business_segment_id=segments[3].id,
        ),
        Client(
            name="PayQuick Solutions",
    ...
    subjects = [
        (
            ...
            "I submitted my loan application 5 days ago and haven't received any update.",
            "medium",
            "application",
        ),
        (
            "Payment failed",
            "My payment of $500 failed with error code E-4012. Please help.",
            "high",
            "transaction",
        ),
        (
            "Interest rate inquiry",
            "Can you provide details on current interest rates for a 30-year fixed mortgage?",
            "low",
            "inquiry",
        ),
        (
            "Disputed transaction",
            "I see an unauthorized charge of $299 on my statement. Please investigate.",
            "critical",
            "dispute",
        ),
        (
            "Account access issue",
            "I'm unable to log into my account since yesterday.",
            "high",
            "access",
        ),
        (
            "Refund request",
            "I need a refund for the duplicate payment made on March 15.",
            "medium",
            "refund",
        ),
        (
            "Insurance claim follow-up",
            "Following up on claim #CLM-2024-1234 submitted last week.",
            "medium",
            "claim",
        ),
        (
            "Portfolio rebalancing",
            "I'd like to discuss rebalancing my investment portfolio.",
            "low",
            "consultation",
        ),
        (
            "Late payment fee waiver",
            "Requesting waiver of late payment fee due to system outage.",
            "medium",
            "fee",
        ),
        (
            "Card replacement",
            "My debit card was lost. Please issue a replacement.",
            "high",
            "card",
        ),
        (
            "Loan pre-approval",
            "I'd like to get pre-approved for a home loan.",
            "medium",
            "application",
        ),
        (
            "Wire transfer delay",
            "Wire transfer initiated 3 days ago still not received by beneficiary.",
            "high",
            "transaction",
        ),
    ]
